    ...
    <div
        ...
        <div class="flex items-center gap-2 sm:gap-4 lg:hidden">
            ...
            <a class="block flex-shrink-0 lg:hidden" href="index.html">
                <img src="build/src/images/logo/logo-icon.svg" alt="Logo" />
            </a>
        </div>
                        ...
                        <ul class="flex h-auto flex-col overflow-y-auto">
                            <li>
                                <a
                                    ...
                                    <div class="h-12.5 w-12.5 rounded-full">
                                        <img src="build/src/images/user/user-02.png" alt="User" />
                                    </div>
                            ...
                            <li>
                                <a
                                    ...
                                    href="messages.html">
                                    <div class="h-12.5 w-12.5 rounded-full">
                                        <img src="build/src/images/user/user-01.png" alt="User" />
                                    </div>
                            ...
                            <li>
                                <a
                                    ...
                                    href="messages.html">
                                    <div class="h-12.5 w-12.5 rounded-full">
                                        <img src="build/src/images/user/user-03.png" alt="User" />
                                    </div>
                            ...
                            <li>
                                <a
                                    ...
                                    href="messages.html">
                                    <div class="h-12.5 w-12.5 rounded-full">
                                        <img src="build/src/images/user/user-04.png" alt="User" />
                                    </div>
            ...
            <div
                ...
                <a
                    ...
                    <span class="hidden text-right lg:block">
                        @foreach ($administradores as $element)
                            @if ($_COOKIE["email_login"] == $element->email)
                            <span class="block text-sm font-medium text-black dark:text-white">{{$element->email}}</span>
                            <span class="block text-xs font-medium">{{$element->name}}</span>
                            @endif
                        @endforeach
                    </span>
