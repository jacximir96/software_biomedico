        ...
        <div class="mb-9 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <nav>
                <ol class="flex items-center gap-2">
                    ...
                    <li class="font-medium text-primary">Panel de control</li>
                </ol>
            </nav>
        </div>

        <div
            class="mb-4 grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
            <div
                ...
                <div class="mt-4 flex items-end justify-between">
                    <div>
                        ...
                        <span class="text-sm font-medium">Equipos por Servicio</span>
                    </div>
            ...
            <div
                ...
                <div class="mt-4 flex items-end justify-between">
                    <div>
                        ...
                        <span class="text-sm font-medium">Equipos por compra</span>
                    </div>
            ...
            <div
                ...
                <div class="mt-4 flex items-end justify-between">
                    <div>
                        ...
                        <span class="text-sm font-medium">Usuarios Registrados</span>
                    </div>
            ...
            <div
                ...
                <div class="mt-4 flex items-end justify-between">
                    <div>
                        ...
                        <span class="text-sm font-medium">Mants. por ODS</span>
                    </div>
            ...
            <div
                ...
                <div class="mt-4 flex items-end justify-between">
                    <div>
                        ...
                        <span class="text-sm font-medium">Mants. por OTM</span>
                    </div>
            ...
            <div
                ...
                <div class="mt-4 flex items-end justify-between">
                    <div>
                        ...
                        <span class="text-sm font-medium">Mants. por compra</span>
                    </div>
                ...
                <div class="-mx-8 flex flex-wrap items-center justify-center gap-y-3">
                    <div class="w-full px-8 sm:w-1/2">
                        <div class="flex w-full items-center">
                            <span
                                class="mr-2 block h-3 w-full max-w-3 rounded-full bg-primary"></span>
                            <p
                    ...
                    <div class="w-full px-8 sm:w-1/2">
                        <div class="flex w-full items-center">
                            <span
                                class="mr-2 block h-3 w-full max-w-3 rounded-full bg-[#6577F3]"></span>
                            <p
                                class="flex w-full justify-between text-sm font-medium text-black dark:text-white">
                                <span> Tablet </span>
                                <span> 34% </span>
                    ...
                    <div class="w-full px-8 sm:w-1/2">
                        <div class="flex w-full items-center">
                            <span
                                class="mr-2 block h-3 w-full max-w-3 rounded-full bg-[#8FD0EF]"></span>
                            <p
                                class="flex w-full justify-between text-sm font-medium text-black dark:text-white">
                                <span> Mobile </span>
                                <span> 45% </span>
                    ...
                    <div class="w-full px-8 sm:w-1/2">
                        <div class="flex w-full items-center">
                            <span
                                class="mr-2 block h-3 w-full max-w-3 rounded-full bg-[#0FADCF]"></span>
                            <p
                                class="flex w-full justify-between text-sm font-medium text-black dark:text-white">
                                <span> Unknown </span>
                                <span> 12% </span>
