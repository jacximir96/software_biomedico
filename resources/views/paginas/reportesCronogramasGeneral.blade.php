...
<body>
    ...
    <table class="table table-bordered table-sm" id="tabla_cronogramaGeneral" style="text-align:center;">
        ...
        <tbody>
            @foreach($cronogramasGeneral as $key => $valorCronogramasGeneral)
            <tr>
                ...
                <td style="vertical-align : middle;text-align:left;">{{$valorCronogramasGeneral->nombre_equipo}}</td>
                <td style="vertical-align : middle;text-align:center;">{{$valorCronogramasGeneral->marca_equipo}}</td>
                <td style="vertical-align : middle;text-align:center;">{{$valorCronogramasGeneral->modelo_equipo}}</td>
                <td style="vertical-align : middle;text-align:center;">{{$valorCronogramasGeneral->serie_equipo}}</td>
                <td style="vertical-align : middle;text-align:center;">{{$valorCronogramasGeneral->cp_equipo}}</td>
