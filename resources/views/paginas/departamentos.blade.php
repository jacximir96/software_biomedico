        ...
        <div class="mb-5 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <nav>
                <ol class="flex items-center gap-2">
                    ...
                    <li class="font-medium text-primary">Departamentos</li>
                </ol>
            </nav>
        </div>
                            ...
                            <div x-data="{ isOptionSelected: false }"
                                ...
                                <select
                                    ...
                                    @foreach ($direccionesEjecutivas as $key => $value1)
                                        <option value="{{$value1->id_direccionEjecutiva}}" class="text-body">{{$value1->nombre_direccionEjecutiva}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
            ...
            <div class="flex flex-wrap justify-between items-center p-4 border-b px-4 py-6 md:px-6 xl:px-7.5">
                ...
                <div id="asignar-botones">
                        ...
                        <div class="modal-content bg-white rounded-lg shadow-lg min-w-300 w-70-1 max-w-screen-2xl dark:border-strokedark dark:bg-boxdark">
                            ...
                            <form method="POST" action="{{ url('/') }}/departamentos">
                                ...
                                <div class="flex justify-between items-center p-4 border-b border-gray-200">
                                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Crear departamento</h3>
                                ...
                                <div class="flex flex-wrap gap-5.5 p-6.5">
                                    <div class="w-full-mitad md:w-full">
                                        ...
                                        <input type="text" placeholder="Ingrese el nombre" name="nombre_departamento" value="{{ old("nombre_departamento") }}" required autofocus
                                            class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary" />
                                    </div>
                                    ...
                                    <div class="w-full-mitad md:w-full">
                                        ...
                                        <input type="text" placeholder="Ingrese las iniciales" name="iniciales_departamento" value="{{ old("iniciales_departamento") }}" required autofocus
                                            class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary" />
                                    </div>
                                    ...
                                    <div class="w-full-mitad md:w-full">
                                        ...
                                        <div x-data="{ isOptionSelected: false }"
                                            ...
                                            <select
                                                ...
                                                @change="isOptionSelected = true" name="estado_departamento" required>
                                                <option value="1" class="text-body">Activo</option>
                                                <option value="2" class="text-body">Inactivo</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="w-full-mitad md:w-full">
                                        ...
                                        <div x-data="{ isOptionSelected: false }"
                                            ...
                                            <select
                                                class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                                                :class="isOptionSelected && 'text-black dark:text-white'"
                                                @change="isOptionSelected = true" name="id_direccionEjecutiva" required>
                                                <option value="">-- Seleccionar la Dirección Ejecutiva --</option>
                                                @foreach ($direccionesEjecutivas as $key => $value)
                                                    <option value="{{$value->id_direccionEjecutiva}}" class="text-body">{{$value->nombre_direccionEjecutiva}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                    ...
                    <div id="editarModal" class="modal fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 hidden z-999999">
                        <div class="modal-content bg-white rounded-lg shadow-lg min-w-300 w-70-1 max-w-screen-2xl dark:border-strokedark dark:bg-boxdark">
                            <form id="editForm" method="POST" action="{{ url('/') }}/departamentos">
                                @csrf
                                @method('PUT')
                                <div class="flex justify-between items-center p-4 border-b border-gray-200">
                                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Editar departamento</h3>
                                ...
                                <div class="flex flex-wrap gap-5.5 p-6.5">
                                    <div class="w-full-mitad md:w-full">
                                        ...
                                        <input type="text" placeholder="Ingrese el nombre" name="nombre_departamento" id="nombre_departamento" value="{{ old("nombre_departamento") }}" required autofocus
                                            class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary" />
                                    </div>
                                    ...
                                    <div class="w-full-mitad md:w-full">
                                        ...
                                        <input type="text" placeholder="Ingrese las iniciales" name="iniciales_departamento" id="iniciales_departamento" value="{{ old("iniciales_departamento") }}" required autofocus
                                            class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary" />
                                    </div>
                                    ...
                                    <div class="w-full-mitad md:w-full">
                                        ...
                                        <div x-data="{ isOptionSelected: false }"
                                            ...
                                            <select
                                                class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                                                :class="isOptionSelected && 'text-black dark:text-white'"
                                                @change="isOptionSelected = true" name="estado_departamento" id="estado_departamento" required>
                                    ...
                                    <div class="w-full-mitad md:w-full">
                                        ...
                                        <div x-data="{ isOptionSelected: false }"
                                            ...
                                            <select
                                                class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                                                :class="isOptionSelected && 'text-black dark:text-white'"
                                                @change="isOptionSelected = true" name="id_direccionEjecutiva" id="id_direccionEjecutiva" required>
                                                @foreach ($direccionesEjecutivas as $key => $value1)
                                                <option value="{{$value1->id_direccionEjecutiva}}" class="text-body">{{$value1->nombre_direccionEjecutiva}}</option>
                                                @endforeach
                                            </select>
                    ...
                    <div class="datatable-wrapper datatable-loading no-footer searchable fixed-columns">
                        <div class="datatable-top">
                            ...
                            <div class="datatable-search">
                                <input class="datatable-input" placeholder="Escribe para buscar" type="search" title="Search within table" aria-controls="tablaDepartamentos">
                            </div>
                        </div>
                        <div class="datatable-container">
                            <table class="table w-full table-auto datatable-table" id="tablaDepartamentos">
                                <thead>
                                    <tr>
...
<script>
    $(document).ready(function() {
        ...
        $('#searchBtn').on('click', function() {
            ...
            var direccionEjecutiva = $('#direccionEjecutiva').val();

            console.log(direccionEjecutiva);
            console.log("aquii");
            ...
            table.column(4).search(direccionEjecutiva);
...
<script>
    document.getElementById('clearBtn').addEventListener('click', function() {
        ...
        document.getElementById('direccionEjecutiva').selectedIndex = 0;
        var table = $('#tablaDepartamentos').DataTable();
...
<script>
    notie.alert({
        type:3,
        text:'!Error en el gestor de departamentos', 
        time:10
    });
</script>
@endif
