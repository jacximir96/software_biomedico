...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Cronograma General (Inter. Programadas)</h1>
          </div>
          <div class="col-sm-6">
        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ url('/') }}/reportesCronogramaGeneralNuevo/cronogramaGeneralPdf" target="_blank" class="btn btn-success btn-sm" style="float:right;">
                        Exportar a PDF
                    </a>
                ...
                id="tablaCronogramasGeneralNuevo">
                    ...
                    {{-- <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-transform: uppercase;">{{$valor_cronogramasGeneral->nombre_equipoGarantia}}</td>
                            <td style="text-transform: uppercase;">{{$valor_cronogramasGeneral->marca_equipoGarantia}}</td>
                            <td style="text-transform: uppercase;">{{$valor_cronogramasGeneral->modelo_equipoGarantia}}</td>
                            <td style="text-transform: uppercase;">{{$valor_cronogramasGeneral->serie_equipoGarantia}}</td>
                            <td style="text-transform: uppercase;">{{$valor_cronogramasGeneral->cp_equipoGarantia}}</td>

                                @switch($valor_cronogramasGeneral->mes_cronogramaGeneralNuevo)
                                            @case(1)
                            ...
                            <td style="text-transform: uppercase;">{{$valor_cronogramasGeneral->año_cronogramaGeneralNuevo}}</td>
                            <td style="text-transform: uppercase; text-align:center;">
                                @if($valor_cronogramasGeneral->realizado == NULL)
                                    <i class="fas fa-times text-red" style="text-align:center;"></i>
                                @elseif($valor_cronogramasGeneral->realizado == 1)
                            ...
                            <td style="text-align: center;">
                                <div class="btn-group">
                                    <a href="{{url('/')}}/cronogramasGeneralNuevo/{{$valor_cronogramasGeneral->id_cronogramaGeneralNuevo}}" class="btn btn-warning btn-sm">
                                        <i class="fas fa-pencil-alt text-white"></i>
                                    </a>

                                    <button class="btn btn-danger btn-sm eliminarRegistro" action="{{url('/')}}/cronogramasGeneralNuevo/{{$valor_cronogramasGeneral->id_cronogramaGeneralNuevo}}"
                                        method="DELETE" pagina="cronogramasGeneralNuevo" token="{{ csrf_token() }}">
                                        <!-- @csrf -->
...
<div class="modal" id="crearCronogramaGeneral">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="POST" action="{{ url('/') }}/cronogramasGeneralNuevo" id="form">
                <!-- @csrf -->
                ...
                <div class="modal-body">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <div class="col-md-8">
                                <select class="form-control" name="mes_cronograma" id="mes_cronograma" required>
                                    <option value="">
                                        -- Seleccionar el Mes --
                                    </option>
                                    @for($i=1; $i<=12; $i++)
                    ...
                    <div class="input-group mb-3">
                        ...
                        <div class="col-md-8">
                            <input type="text" class="form-control" name="año_cronograma" id="año_cronograma"
                    ...
                    <div class="col-md-12">
                        ...
                        id="tablaCronogramasGeneralesNuevo">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{$value_equipos->id_equipoGarantia}}</td>
                                    <td>{{$value_equipos->nombre_equipoGarantia}}</td>
                                    <td>{{$value_equipos->cp_equipoGarantia}}</td>
                                    <td></td>
                                </tr>
                                @endforeach
...
@if ($status == 200)
    ...
    @foreach ($cronogramaGeneralNuevoUnidad as $key => $value)

    <div class="modal" id="editarCronogramaGeneral">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="POST" action="{{ url('/') }}/cronogramasGeneralNuevo/{{$value->id_cronogramaGeneralNuevo}}"
                    ...
                    <div class="input-group mb-3">
                        ...
                        <div class="col-md-6">
                            <select class="form-control" name="mes_cronogramaGeneral" required>
                                        @switch($value->mes_cronogramaGeneralNuevo)
                                            @case(1)
                                                <option value="1">
                                                    ENERO
                                                </option>
                                        ...
                                        @if($value->mes_cronogramaGeneralNuevo == $i)
