    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header bg-info">
                <h4 class="modal-tittle">Crear Administrador</h4>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select class="form-control" name="id_rol" required>
                                ...
                                @foreach ($roles as $key => $value2)
                                        ...
                                        <option value="{{$value2->id}}" style="text-transform: lowercase;">
                                            {{$value2->name}}
                                        </option>{{-- Aparece todo menos el que es diferente --}}
        ...
        <div class="modal" id="editarAdministrador">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-header bg-info">
                        <h4 class="modal-tittle">Editar Administrador</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
                    <div class="modal-body">
                        {{-- Nombre --}}
