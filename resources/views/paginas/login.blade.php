                            ...
                            <div class="hidden w-full xl:block xl:w-1/2">
                                <div class="px-26 py-17.5 text-center">
                                    <a class="mb-5.5 inline-block" href="index.html">
                                        <img class="hidden dark:block" src="build/src/images/logo/logo.svg" alt="Logo" />
                                        <img class="dark:hidden" src="build/src/images/logo/logo-dark.svg" alt="Logo" />
                                    </a>

                                    <p class="font-medium 2xl:px-20">
                                        Bienvenidos al software biomédico, donde podras gestionar tus mantenimientos preventivos
                                        y correctivos en base a cada equipo.
                                    </p>

                                    <span class="mt-15 inline-block">
                                        <img src="build/src/images/illustration/illustration-03.svg" alt="illustration" />
                                    </span>
                                </div>
                            </div>
                            <div class="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
                                <div class="w-full p-4 sm:p-12.5 xl:p-17.5">
                                    <span class="mb-1.5 block font-medium">Inicio de sesión</span>
                                    ...
                                    <form method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="relative">
                                                ...
                                                <input id="email" type="email" class="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary form-control email_login @error('email') is-invalid
                                        ...
                                        <div class="mb-6">
                                            ...
                                            <div class="relative">
                                                ...
                                                <input id="password" type="password" class="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary form-control @error('password') is-invalid @enderror"
