        ...
        <div class="mb-5 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <nav>
                <ol class="flex items-center gap-2">
                    ...
                    <li class="font-medium text-primary">Equipos de reposición</li>
                </ol>
            </nav>
        </div>

        <div class="rounded-lg shadow-md bg-white shadow-default dark:border-strokedark dark:bg-boxdark mb-4">
            <div class="flex flex-wrap justify-between items-center border-b p-4 px-4 py-6 md:px-6 xl:px-7.5">
                <div class="col-sm-12">
                    <div class="callout callout-info col-md-12" style="float:left;">
                        <h5 class="block text-sm font-medium text-black dark:text-white">
                            <span class="spinner-grow text-danger"></span>
                            <i> Leyenda:</i>
                        </h5>

                        <ul>
                            <li>Criterio 1: <span>El equipo se encuentra en estado de conservación malo.</span></li>
                            <li>Criterio 2: <span>El costo supera el 40% del valor del equipo.</span></li>
                            <li>Criterio 3: <span>No existe soporte técnico en el mercado nacional.</span></li>
                            <li>Criterio 4: <span>El equipo tiene mayores costos de operación comparado con otros similares.</span></li>
                            <li>Criterio 5: <span>Tiene una antiguedad mayor al tiempo de vida util recomendado por el fabricante.</span></li>
                            <li>Criterio 6: <span>El equipo no se encuentra vigente tecnológicamente.</span></li>
                            <li>Criterio 7: <span>Condición de seguridad.</span></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div id="asignar-botones">
                    <div id="editarModal" class="modal fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 hidden z-999999">
                        <div class="modal-content bg-white rounded-lg shadow-lg min-w-300 w-70-1 max-w-screen-2xl dark:border-strokedark dark:bg-boxdark">
                            <form id="editForm" method="POST" action="{{ url('/') }}/equiposReposicion">
                                @csrf
                                @method('PUT')
                                <div class="flex justify-between items-center p-4 border-b border-gray-200">
                                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Dar de baja a equipo</h3>
                                ...
                                <div class="flex flex-wrap gap-5.5 p-6.5">
                                    <div class="w-full-mitad md:w-full">
                                        ...
                                        <input type="date" placeholder="Ingrese el nombre" name="fecha_baja" id="fecha_baja" value="{{ old("fecha_baja") }}" required autofocus
                                            class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary" />
                                    </div>
                                    ...
                                    <div class="w-full-mitad md:w-full">
                                        ...
                                        <div x-data="{ isOptionSelected: false }"
                                            ...
                                            <select
                                                ...
                                                @change="isOptionSelected = true" name="equipo_baja" id="equipo_baja" required>
                                                <option value="">-- Seleccionar el equipo --</option>
                                                @foreach($equiposGarantia = App\EquiposGarantiaModel::all() as $key => $value_equipos)
                                                    <option value="{{$value_equipos->nombre_equipoGarantia}}" class="text-body">{{$value_equipos->nombre_equipoGarantia}},Cod. Patrimonial: {{$value_equipos->cp_equipoGarantia}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                    ...
                    <div class="datatable-wrapper datatable-loading no-footer searchable fixed-columns">
                        <div class="datatable-top">
                            ...
                            <div class="datatable-search">
                                <input class="datatable-input" placeholder="Escribe para buscar" type="search" title="Search within table" aria-controls="tablaEquiposReposicion">
                            </div>
                        </div>
                        <div class="datatable-container">
                            <table class="table w-full table-auto datatable-table" id="tablaEquiposReposicion">
                                <thead>
                                    <tr>
...
<script>
    $(document).ready(function() {
        var table = $('#tablaEquiposReposicion').DataTable();
