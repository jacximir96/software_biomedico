...
class EquiposReposicionController extends Controller
{
    public function index(){
        ...
        return view("paginas.equiposReposicion",  array("administradores"=>$administradores,"suma_criterios"=>$suma_criterios,
                                                        "equipos_criterios"=>$equipos_criterios,"notificacionesCronogramaNuevo"=>$notificacionesCronogramaNuevo,
    ...
    public function show($id){
        ...
        if(count($equipo_criterio) != 0){
            return view("paginas.equiposReposicion",array("status"=>200,"equipo_criterio"=>$equipo_criterio,"equiposGarantia"=>$equiposGarantia,
        ...
        "notificacionesCronogramaNuevo"=>$notificacionesCronogramaNuevo,"cantidadNotificacionesCronogramaNuevo"=>$cantidadNotificacionesCronogramaNuevo));
            ...
            return view("paginas.equiposReposicion",array("status"=>404,"equipo_criterio"=>$equipo_criterio,"equiposGarantia"=>$equiposGarantia,
            "administradores"=>$administradores,"equipos_criterios"=>$equipos_criterios,"suma_criterios"=>$suma_criterios,
            "notificacionesCronogramaNuevo"=>$notificacionesCronogramaNuevo,"cantidadNotificacionesCronogramaNuevo"=>$cantidadNotificacionesCronogramaNuevo));
        }
    }
