        ...
        if(request()->ajax()){
            ...
            ->addColumn('acciones', function($data){
                ...
                '<div class="btn-group text-center">
                    <button data-modal-target="editarModal" class="open-modal-btn hover:text-primary editar-btn" data-id="' .$data->id_departamento.'">
                        <svg
                        class="fill-current"
                        width="24"
                        height="24"
                    ...
                    <button class="hover:text-primary eliminarRegistro" action="'.url()->current().'/'.$data->id_departamento.'" 
